...
available: \testit{pyfai@esrf.fr} (send ``subscribe pyfai'' by e-mail to
\testit{sympa@esrf.fr} to subscribe to the mailing list). New features
...
in other well-known Linux distributions like Ubuntu.
