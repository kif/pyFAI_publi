...
The calibration tool of pyFAI, called \textem{pyFAI-cali} has been available
...
\item \textem {recalib n}: extract a new set of control points from the $n$
...
reasonable using \textem{recalib n} then \textem{free wavelength} and $refine$
