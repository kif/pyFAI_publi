...
Azimuthal integration allows using area detectors for recording powder diffraction patterns, which 
...
sometimes limits the productivity of modern synchrotron beamlines, where diffraction is used to probe samples with a 
pencil beam in 2D raster scans or diffraction tomography experiments by using very fast detectors. 

Python\ldots. pyFAI 

This contribution introduces how a powder diffraction 
experiment is described within pyFAI: composed of a detector and its position
in space.
...
It is woth mentionning that direct histogram without pixel splitting is the only
method which allows precise measurement of the error\cite{billinge2014}.
