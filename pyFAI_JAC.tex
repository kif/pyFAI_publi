...
This is why detector needs more complex definition than just the pixel size. 
...
The diffraction image is sequentially blurred with Gaussian filters of
...
Command Line Interface (CLI) mode, like setting, constraining, fixing and
...
masking. The check-boxes next to each field allows to activate (or not) the given
correction.
The third frame contains information about the output format, the number of bins
in radial and azimuthal dimensions together with the output space.
