...
The second frame targets the correction to be applied: dark current subtraction,
...
LaB$_6$ is chosen among the known calibrants before the the wavelength is set.
...
detector (image taken at the ID23-2 beamline of the synchrotron ESRF). A
...
pyFAI be ported to GPU to off-load the processor? 
The GUI for calibration and integration, while helpful, are really minimalistic.
